...
class CI_DB_driver {
	...
	function display_error($error = '', $swap = '', $native = FALSE)
	{
        ...
        /*catch exception*/
                ...
                //var_dump($msg3); die();
                $CI->session->set_userdata("error_msg",$msg3);
                $CI->airbrake->notifyOnError($msg3);
                //$uel="https://apps2.cuecow.com/index.php/page/show_error?guid=".$guid."";
                //redirect($uel); 
		echo $error->show_dberror($guid,$msg3);
		exit;
	}
