...
<script type="text/javascript" src="<?=base_url();?>js/temp8js.js"></script>
        ...
        <div class="gallery-app-inner-container-data">
            ...
            <div class="gallery-app-main-col">
                <div class="gallery-app-left-col">
                    <div style="width:179px; margin:0px auto;"><img src="<?=base_url()?>images/196X205/<?=$tempdata[1][2]['value'];?>" width="179" /></div>
                </div>
            ...
            <div id="content" class="content">
                ...
                <div class="nav">
                    <ul id="menu" class="menu">
                        <li class="menu-1 <?=($mode=="" ? 'active' : '');?>"><a href="<?=base_url();?>index.php/gallery_app?mode=<?=SIGNED_REQUEST;?>"><span><?=$tempdata[2][0]['value'];?></span></a></li>
                        <li class="menu-2 <?=($mode=="popular" ? 'active' : '');?>"><a href="<?=base_url();?>index.php/gallery_app?mode=popular<?=SIGNED_REQUEST;?>"><span><?=$tempdata[2][1]['value'];?></span></a></li>
                        <li class="menu-3 <?=($mode=="archive" ? 'active' : '');?>"><a href="<?=base_url();?>index.php/gallery_app?mode=archive<?=SIGNED_REQUEST;?>"><span><?=$tempdata[2][2]['value'];?></span></a></li>
                    </ul><!-- .menu -->
                    <div class="search">
                        <form action="<?=base_url();?>index.php/gallery_app?appid=<?=$appid;?>" method="post" id="searchForm">
...
<?php $this->load->view('datatemp8', $tempdata);?>
</body>
</html>