    ...
    <div id="Settings">
       <form action="#" method="post">
        <table border="0">
            ...
            <tr>
                <td width="130"><b>Snow falling:</b></td>
