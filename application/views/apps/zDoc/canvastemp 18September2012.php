            ...
            <div id="content" class="content">
                ...
                <div class="nav">
                    <ul id="menu" class="menu">
                        <li class="menu-1 active"><a onclick="getSubmits( 1, 'latest', '' ); return false;" href="#"><span>Seneste</span></a></li>
                        <li class="menu-2"><a onclick="getSubmits( 1, 'popular', '' ); return false;" href="#"><span>Højest ratede</span></a></li>
                        <li class="menu-3"><a onclick="getSubmits( 1, 'archived', '' ); return false;" href="#"><span>Arkiv</span></a></li>
                    </ul><!-- .menu -->
                    <div class="search">
                ...
                <ul id="submits" class="submits">
                    ...
                    <li id="submit-339" class="submitPosition-1" style="z-index: auto;">
                        <div class="preview">
                            ...
                            <img src="<?=base_url()?>images/images/galleryimages/<?=$pics['picture'];?>" class="image" width="160" height="160">
                        </div>
                ...
                <ul id="pagination" class="pagination">
                    <li class="active"><a onclick="return false;" href="#1">1</a></li>
                    <li><a onclick="getSubmits( 2, 'latest', searchValue ); return false;" href="#2">2</a></li>
                    <li><a onclick="getSubmits( 3, 'latest', searchValue ); return false;" href="#3">3</a></li>
                    <li><a onclick="getSubmits( 19, 'latest', searchValue ); return false;" href="#19">Sidste</a></li>
                </ul><!-- .pagination -->
            </div>
            <!-------------------------------------------------------------->
            <div class="nav">
