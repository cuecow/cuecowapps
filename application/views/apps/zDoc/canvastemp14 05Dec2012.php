    ...
    <div class="christmas-app-data-container">
        ...
        <div style="overflow: hidden; height: 135px;position: absolute;">
            <div id="share" onMouseOver="dmove('in');" onMouseOut="dmove('out');">
                <ul>
                    <li><a class="icon-facebook rel="nofollow" href="javascript:void(0);" onclick="return fbs_click()" target="_blank" >Facebook<span>&nbsp;</span></a></li>
        ...
        <div class="calendar-holder">
            <ul style="padding: 16px 0 14px 18px;">
                <?php 
                for($j=1;$j<25;$j++){
...
<div id="overlay" style="display: none;">
    <div class="thankyoudiv" align="center">
        <h3>Thank you for Participate!</h3>
