    ...
    <div class="page-design-main-wrapper">
        ...
        <div class="page-design-data-slice">
            <div class="page-design-top-container">
                    ...
                    <div  style="position:absolute;margin-top:-34px;margin-left:700px;" align="center" class="tempeditpng">
                        <a class="editdiv" href="<?=base_url();?>index.php/page/editpopup?val_id=<?=$tempdata[1][2]['id'];?>&ftype=<?=$tempdata[1][2]['typeid'];?>">Change Image</a>
                    </div>
                    <a href="#" class="page-design-logo-header"><img src="<?=  base_url();?>images/images/<?=$tempdata[1][2]['value'];?>" width="145" height="17" /></a>
                <div class="clear"></div>
            ...
            <div class="page-design-middle-left">
                    ...
                    <div  style="position:absolute;margin-top:-1px;margin-left:-126px;" align="center" class="tempeditpng">
                        <a class="editdiv" href="<?=base_url();?>index.php/page/editpopup?val_id=<?=$tempdata[3][0]['id'];?>&ftype=<?=$tempdata[3][0]['typeid'];?>">Change Image</a>
                    </div>
                    <img src="<?=  base_url();?>images/images/<?=$tempdata[3][0]['value'];?>" width="117" height="147" class="page-design-images-thmb" />
                    <div  style="position:absolute;margin-top:-19px;margin-left:114px;" align="center" class="tempeditpng">
                        <a class="editdiv" href="<?=base_url();?>index.php/page/editpopup?val_id=<?=$tempdata[3][1]['id'];?>&ftype=<?=$tempdata[3][1]['typeid'];?>">Change Image</a>
                    </div>
                    <img src="<?=  base_url();?>images/images/<?=$tempdata[3][1]['value'];?>" width="117" height="147" class="page-design-images-thmb" />
                    ...
                    <img src="<?=  base_url();?>images/images/<?=$tempdata[3][2]['value'];?>" width="117" height="147" class="page-design-images-thmb" />
                    <div class="clear"></div>
            ...
            <div class="page-design-middle-right">
                    ...
                    <img src="<?=  base_url();?>images/images/<?=$tempdata[4][1]['value'];?>" width="372" height="454" />
