...
<div id="tabs" style="font-size:12px;background-color:#FFFFFF">
    ...
    <div id="edittemplate">
        <div  style="position: absolute; margin-top: 41px; margin-left: 705px;" align="center" class="tempeditpng">
        ...
        <div class="gallery-app-main-wrapper">
            <div class="gallery-app-sun-image">
                <div  style="position: absolute; margin-top: 10px; margin-left: 107px;" align="center" class="tempeditpng">
                    <a class="editdiv" href="<?=base_url();?>index.php/page/edit_image?val_id=<?=$tempdata[0][1]['id'];?>&ftype=<?=$tempdata[0][1]['typeid'];?>&width=130&height=42">Change image</a>
                </div>
            </div>
                ...
                <div class="gallery-app-inner-container-data">
                    <div class="gallery-app-logo">
                        <div  style="position: absolute; margin-left: 261px; margin-top: 0px;;" align="center" class="tempeditpng">
                            <a class="editdiv" href="<?=base_url();?>index.php/page/edit_image?val_id=<?=$tempdata[1][0]['id'];?>&ftype=<?=$tempdata[1][0]['typeid'];?>&width=438&height=66">Change image</a>
                        </div>
                    </div>
                    <div class="clear"></div>
                        ...
                        <div class="gallery-app-left-col">
                            <div style="width:179px; margin:0px auto;">
                                <div  style="position: absolute; margin-left: -75px; margin-top: 15px;" align="center" class="tempeditpng">
                                    <a class="editdiv" href="<?=base_url();?>index.php/page/edit_image?val_id=<?=$tempdata[1][2]['id'];?>&ftype=<?=$tempdata[1][2]['typeid'];?>&width=196&height=205">Change image</a>
                                </div>
                                <img src="<?=base_url()?>images/196X205/<?=$tempdata[1][2]['value'];?>" width="179" />
                            </div>
                        </div>
