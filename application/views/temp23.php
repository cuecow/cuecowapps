    ...
    <div class="design-entertain-main-wrapper">
        ...
        <div class="design-entertain-data-slice">
            ...
            <div  style="position: absolute; margin-top: 2px; margin-left: 674px;" align="center" class="tempeditpng">
                <a class="editdiv" href="<?=base_url();?>index.php/page/edit_image?val_id=<?=$tempdata[1][0]['id'];?>&ftype=<?=$tempdata[1][0]['typeid'];?>&width=830&height=420">Change Image</a>
            </div>
            ...
            <div class="design-entertain-middle-left">
                ...
                <div  style="position: absolute; margin-top: 21px; margin-left: -118px;;" align="center" class="tempeditpng">
                    <a class="editdiv" href="<?=base_url();?>index.php/page/edit_image?val_id=<?=$tempdata[3][2]['id'];?>&ftype=<?=$tempdata[3][2]['typeid'];?>&width=375&height=180">Change Image</a>
                </div>
            ...
            <div class="design-entertain-middle-right">
                    <div  style="position: absolute; margin-top: 8px; margin-left: 338px;;" align="center" class="tempeditpng">
                        <a class="editdiv" href="<?=base_url();?>index.php/page/edit_image?val_id=<?=$tempdata[3][5]['id'];?>&ftype=<?=$tempdata[3][5]['typeid'];?>&width=406&height=490">Change Image</a>
                    </div>
            ...
            <div class="design-entertain-footer-container">
                ...
                <div  style="position: absolute; margin-top: -28px; margin-left: 718px;;" align="center" class="tempeditpng">
                    <a class="editdiv" href="<?=base_url();?>index.php/page/edit_image?val_id=<?=$tempdata[4][1]['id'];?>&ftype=<?=$tempdata[4][1]['typeid'];?>&width=90&height=25">Change Image</a>
                </div>
