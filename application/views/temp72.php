...
<div id="tabs" style="font-size:12px;background-color:#FFFFFF">
    ...
    <div id="edittemplate">
        <!--********************************************-->
        <div align="center">
            <div  style="position: absolute; margin-left: 167px; margin-top: -5px;" align="center" class="tempeditpng">
                <a class="editdiv" href="<?=base_url();?>index.php/page/editpopup?val_id=<?=$tempdata[1][6]['id'];?>&ftype=<?=$tempdata[1][6]['typeid'];?>">Change Link</a>
            </div>        
            Action Url: <?=$tempdata[1][6]['value'];?>
        </div>        
                ...
                <div class="signup_app_entertain-data-main">
                    <div class="signup_app_entertain-top-content">
                        <div class="signup_app_entertain-top-content-inner">
                                <div  style="position: absolute; margin-left: 30px; margin-top: 11px;" align="center" class="tempeditpng">
                                    <a class="editdiv" href="<?=base_url();?>index.php/page/editpopup?val_id=<?=$tempdata[0][0]['id'];?>&ftype=<?=$tempdata[0][0]['typeid'];?>">Change Image</a>
                                </div>
