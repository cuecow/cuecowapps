...
.gallery-app-inner-container-data {
	background:url(<?=base_url()?>images/images/gallery-app-bg_03.png) repeat-y;
	width:810px;
	height:auto;
}
...
.gallery-app-left-col {
	float:left;
	width:288px;
}

.gallery-app-left-col img {
	padding:30px 0 0 0;
}
...
/* ***** *****   M E N U   ***** ***** */
 ...
 .content .nav ul.menu li.menu-1 a span { background-image: url(<?=base_url();?>images/images/menu-1.png);}
 .content .nav ul.menu li.menu-2 a span { background-image: url(<?=base_url();?>images/images/menu-2.png);}
 .content .nav ul.menu li.menu-3 a span { background-image: url(<?=base_url();?>images/images/menu-3.png);}

 .content .nav ul.menu li.hover,  .content .nav ul.menu li.active {
    background: url(<?=base_url();?>images/images/buttonSmallLeft.png) no-repeat left center;
}
  .content .nav ul.menu li.hover a,   .content .nav ul.menu li.active a {
    background: url(<?=base_url();?>images/images/buttonSmallRight.png) no-repeat right center;
}
  .content .nav ul.menu li.hover a span,   .content .nav ul.menu li.active a span {
    color: #fff;
    background-position: left 0;
}
...
/* ***** *****   P R E V I E W   ***** ***** */
  .content ul.submits li .preview {
    position: relative;
    padding: 8px;
    border: 1px solid #BEBEBE;
    background: #fff;
}
  .content ul.submits li .preview .votes {
    position: absolute;
    right: 11px;
    top: 11px;
    padding-left: 23px;
...
/* ***** *****   Z O O M   ***** ***** */
  ...
  .content ul.submits li.submitPosition-1 .zoom { left: 1px; top: 1px;}
  .content ul.submits li.submitPosition-2 .zoom { left: -40px; top: 1px;}
  .content ul.submits li.submitPosition-3 .zoom { right: 1px; top: 1px;}
  .content ul.submits li.submitPosition-4 .zoom { left: 1px; bottom: 1px;}
  .content ul.submits li.submitPosition-5 .zoom { left: -40px; bottom: 1px;}
  .content ul.submits li.submitPosition-6 .zoom { right: 1px; bottom: 1px;}

  .content ul.submits li .zoom .image {
    display: block;
    width: 220px;
    height: 220px;
}

  .content ul.submits li .zoom .buttons {
    position: absolute;
    left: 14px;
    top: 14px;
}

  .content ul.submits li .zoom .vote {
    float: left;
    display: block;
    width: 67px;
    height: 31px;
  ...
  .content ul.submits li .zoom .share {
    float: left;
    display: block;
    width: 59px;
    height: 31px;
  ...
  .content ul.submits li .zoom .text {
    position: absolute;
    left: 11px;
    bottom: 11px;
    width: 208px;
...
/* ***** ***** *****   P A G I N A T I O N   ***** ***** ***** */
  ...
  .content ul.pagination li.hover,   .content ul.pagination li.active {
    background: url(<?=base_url();?>images/images/buttonSmallLeft.png) no-repeat left center;
}
  .content ul.pagination li.hover a,   .content ul.pagination li.active a {
    color: #fff;
    background: url(<?=base_url();?>images/images/buttonSmallRight.png) no-repeat right center;
}
