            ...
            <div class="gallery-app-inner-container">                                
                <div class="gallery-app-inner-container-data">
                    <div  style="position:absolute;margin-top:-41px;margin-left:680px;" align="center" class="tempeditpng">
                        <a class="editdiv" href="<?=base_url();?>index.php/page/edit_image?val_id=<?=$tempdata[0][2]['id'];?>&ftype=<?=$tempdata[0][2]['typeid'];?>&width=798&height=345">Change BG Color</a>
                    </div> 
                    <div class="gallery-app-logo" align="center"><img src="<?=base_url()?>images/798X345/<?=$tempdata[1][0]['value'];?>"/>
                        <div  style="position: absolute; margin-left: 52px; margin-top: -60px;" align="center" class="tempeditpng">
                            <a class="editdiv" href="<?=base_url();?>index.php/page/edit_image?val_id=<?=$tempdata[1][0]['id'];?>&ftype=<?=$tempdata[1][0]['typeid'];?>&width=798&height=345">Change image</a>
                        </div>
                    </div>
                    <div class="clear"></div>
