        ...
        <div class="page-design-data-slice">
            ...
            <div class="page-design-middle-left">
                    ...
                    <div  style="position:absolute;margin-top:-1px;margin-left:-126px;" align="center" class="tempeditpng">
                        <a class="editdiv" href="<?=base_url();?>index.php/page/edit_image?val_id=<?=$tempdata[3][0]['id'];?>&ftype=<?=$tempdata[3][0]['typeid'];?>&width=128&height=160">Change Image</a>
                    </div>
                    ...
                    <div  style="position:absolute;margin-top:-19px;margin-left:114px;" align="center" class="tempeditpng">
                        <a class="editdiv" href="<?=base_url();?>index.php/page/edit_image?val_id=<?=$tempdata[3][1]['id'];?>&ftype=<?=$tempdata[3][1]['typeid'];?>&width=128&height=160">Change Image</a>
                    </div>
                    ...
                    <div  style="position:absolute;margin-top:-20px;margin-left:260px;" align="center" class="tempeditpng">
                        <a class="editdiv" href="<?=base_url();?>index.php/page/edit_image?val_id=<?=$tempdata[3][2]['id'];?>&ftype=<?=$tempdata[3][2]['typeid'];?>&width=128&height=160">Change Image</a>
                    </div>
            ...
            <div class="page-design-middle-right">
                    <div  style="position:absolute;margin-top:52px;margin-left:309px;" align="center" class="tempeditpng">
                        <a class="editdiv" href="<?=base_url();?>index.php/page/edit_image?val_id=<?=$tempdata[4][1]['id'];?>&ftype=<?=$tempdata[4][1]['typeid'];?>&width=406&height=490">Change Image</a>
                    </div>
