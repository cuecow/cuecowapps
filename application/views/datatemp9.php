        ...
        <div class="line">
            <div class="left">
                ...
                <div class="uploadWrapper">
                    ...
                    <div id="imguploadfrm">
                    <form id="uploadForm" method="post" action="gallery_app2/addpic/" enctype="multipart/form-data">
...
<div class="dialog" id="thanksDialog" style="display: none;">
 ...
 <div class="dialog" id="alreadyvoted" style="display: none; margin-top:155px">
        <div class="dialogTop"></div>
        <div class="dialogContent">
            <div class="header">
                <?=$tempdata[5][2]['value'];?>
        ...
        <div class="dialogBottom"></div>
        <a class="dialogClose" href="#" onclick="closealreadyvote(); return false;"></a>
    </div><!-- #alreadyvote -->
 <div class="dialog" id="thanks2Dialog" style="display: none; margin-top:65px">
        <div class="dialogTop"></div>
        <div class="dialogContent">
            <div class="header">
                <?=$tempdata[5][3]['value'];?>               
