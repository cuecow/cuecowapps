    ...
    <div class="food-design-main-wrapper">
        ...
        <div class="food-design-data-slice">
            ...
            <div class="food-design-top-container">
                    ...
                    <div  style="position: absolute; margin-top: -12px; margin-left: 704px;" align="center" class="tempeditpng">
                        <a class="editdiv" href="<?=base_url();?>index.php/page/edit_image?val_id=<?=$tempdata[1][2]['id'];?>&ftype=<?=$tempdata[1][2]['typeid'];?>&width=150&height=20">Change image</a>
                    </div>
                    <a href="#" class="food-design-logo-header"><img src="<?=  base_url();?>images/150X20/<?=$tempdata[1][2]['value'];?>" width="122" height="" /></a>
                <div class="clear"></div>
            ...
            <div  style="position: absolute; margin-top: 5px; margin-left: -112px;" align="center" class="tempeditpng">
                <a class="editdiv" href="<?=base_url();?>index.php/page/edit_image?val_id=<?=$tempdata[2][0]['id'];?>&ftype=<?=$tempdata[2][0]['typeid'];?>&width=406&height=490">Change image</a>
            </div>
            <img src="<?=  base_url();?>images/406X490/<?=$tempdata[2][0]['value'];?>" width="760" height="473" />
            ...
            <div class="food-design-middle-right">
                ...
                <div  style="position: absolute; margin-top: 4px; margin-left: 276px;" align="center" class="tempeditpng">
                    ...
                    <div  style="position: absolute; margin-top: 4px; margin-left: 286px;" align="center" class="tempeditpng">
                        <a class="editdiv" href="<?=base_url();?>index.php/page/edit_image?val_id=<?=$tempdata[3][6]['id'];?>&ftype=<?=$tempdata[3][6]['typeid'];?>&width=262&height=230">Change Image</a>
                    </div>
                    <img src="<?=  base_url();?>images/262X230/<?=$tempdata[3][6]['value'];?>" width="335" height="235" />
