        ...
        <div class="gallery-app-main-wrapper">
            <div class="gallery-app-inner-container">                                
                <div class="gallery-app-inner-container-data">
                    ...
                    <div class="gallery-app-logo" align="center"><img src="<?=base_url()?>images/800X390/<?=$tempdata[1][0]['value'];?>"/>
                        <div  style="position: absolute; margin-left: 52px; margin-top: -60px;" align="center" class="tempeditpng">
                            <a class="editdiv" href="<?=base_url();?>index.php/page/edit_image?val_id=<?=$tempdata[1][0]['id'];?>&ftype=<?=$tempdata[1][0]['typeid'];?>&width=800&height=390">Change image</a>
                        </div>
                    </div>
                    <div class="clear"></div>
