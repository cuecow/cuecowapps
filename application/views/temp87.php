        ...
        <form method="get" class="contact-me-app-form">
            <div class="admin-form-cnt">
                <div  style="position: absolute; margin-top: -9px; margin-left: 648px;" align="center" class="tempeditpng">
                    <a class="editdiv" href="<?=base_url();?>index.php/page/edit_image?val_id=<?=$tempdata[0][14]['id'];?>&ftype=<?=$tempdata[0][14]['typeid'];?>&width=770&height=255">Change Image</a>
                </div>
                <img src="<?=  base_url();?>images/770X255/<?=$tempdata[0][14]['value'];?>" width="770" height="500">
