    ...
    <div class="desgin-app-data-slice">
        ...
        <img src="<?=  base_url();?>images/images/<?=$tempdata[2][0]['value'];?>" width="760" height="473" />
        	...
        	<div class="desgin-app-left-col">
            	...
            	<div class="desgin-app-left-img-cnt"><img src="<?=  base_url();?>images/images/<?=$tempdata[2][1]['value'];?>" width="292" height="179" /></div>
        ...
        <div class="desgin-app-middle-right">
        	<img src="<?=  base_url();?>images/images/<?=$tempdata[4][2]['value'];?>" width="372" height="235" />
                <div  style="position:absolute;margin-top:-132px;margin-left:319px;" align="center" class="tempeditpng">
                  <a class="editdiv" href="<?=base_url();?>index.php/page/editpopup?val_id=<?=$tempdata[4][2]['id'];?>&ftype=<?=$tempdata[4][2]['typeid'];?>">Change Image</a>
                </div> 
        ...
        <div class="desgin-app-bottom-container">
            ...
            <div  style="position:absolute;margin-top:-39px;margin-left:697px;" align="center" class="tempeditpng">
                <a class="editdiv" href="<?=base_url();?>index.php/page/editpopup?val_id=<?=$tempdata[5][2]['id'];?>&ftype=<?=$tempdata[5][2]['typeid'];?>">Change Image</a>
            </div>
            <a href="#" class="desgin-app-bottom-logo"><img src="<?=  base_url();?>images/images/<?=$tempdata[5][2]['value'];?>" width="93" height="20" /></a>
            <div class="clear"></div>
