...
<?php if($ftype==1){?>
    <form action="<?=base_url();?>index.php/page/do_editpopup" method="post">
        ...
        { ?>
            <textarea  id="myArea1" name="value"  onclick="toggleArea1();" style="width:400px;height:200px;"><?=$fval_sp?></textarea>
        <?php
        }
        ?>
<!--        <textarea  id="myArea1" name="value"  onclick="toggleArea1();" style="width:400px;height:200px;"><?=$valr['value'];?></textarea>-->
        ...
        <input type="hidden" name="fval_sp"  value="<?=fval_sp?>" />
...
<form action="<?=base_url();?>index.php/page/do_editpopup" method="post">
    <label>Select Color: </label><input type="text" class="color-picker" name="value" size="6" autocomplete="on" maxlength="10" value="<?=$valr['value'];?>" />
...
<form action="<?=base_url();?>index.php/page/do_editpopup" method="post">
    <label>Select Color: </label><input type="text" class="color-picker" name="value" style="width: 100px; margin-top:8px"size="6" autocomplete="on" maxlength="10" value="<?=$valr['temp_bgcolor'];?>" onclick="colorpick();" />
    <input type="submit" value=" Update" align="right" /> 
    <input type="hidden" name="val_id"  value="<?=$val_id?>" />
    <input type="hidden" name="ftype"  value="<?=$ftype?>" />
    <input type="hidden" name="tselect"  value="<?=$tselect?>" />
